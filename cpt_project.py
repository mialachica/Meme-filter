...
textsize = cv2.getTextSize(user_write, font, 1, 2)
...
# Terminal message 
introduction = "\nWelcome to Meme Filter!\n\n\t-This program randomizes different prompts for you to react to!\n\t-When you feel ready click the \"S\" key to take a picture!\n\t-click the \"Q\" key to close the program!\n\nEnjoy!!"

# Informs the user of what they can do 
print(introduction)
